...
[Problem link](https://www.hackerrank.com/challenges/ruby-blocks/problem)
...
and .
The yield statement invokes the block with parameters and
...
n = gets.to_i
factorial do 
    puts (1..n).inject(:*) || 1#_______________________
end
