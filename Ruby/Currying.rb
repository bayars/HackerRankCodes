...
Problem link = https://www.hackerrank.com/challenges/ruby-curry/problem?h_r=next-challenge&h_v=zen&h_r=next-challenge&h_v=zen

Currying is a technique in which a function accepts parameters and turns it into a sequence of
...
In the above example, lambda take two parameters
,
