...
[Problem Link](https://www.hackerrank.com/challenges/ruby-enumerable-group-by/problem?h_r=next-challenge&h_v=zen&h_r=next-challenge&h_v=zen)
...
def group_by_marks(marks, pass_marks)
  # your code here
  marks.group_by { |t,v| v < pass_marks ? "Failed" : "Passed"}
end
