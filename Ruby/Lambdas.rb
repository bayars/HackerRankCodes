=begin
Problem link = https://www.hackerrank.com/challenges/ruby-lambdas/problem?h_r=next-challenge&h_v=zen
...
can use both lambda and stabby lambda, ->.
...
square      = -> (input_number_1) {input_number_1 ** 2}

# Write a lambda which takes an integer and increment it by 1
plus_one    = ->(input_number_1) {input_number_1 + 1}

# Write a lambda which takes an integer and multiply it by 2
into_2      = ->(input_number_2) {input_number_2 * 2}

# Write a lambda which takes two integers and adds them
adder       = ->(input_number_1,input_number_2) {input_number_1 + input_number_2}

# Write a lambda which takes a hash and returns an array of hash values
values_only = ->(input_hash) { input_hash.values }
